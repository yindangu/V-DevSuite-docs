...
打个包过程是跟平常一样，使用mavn或其他工具打包成标准jar包，详细参考《把原始jar包部署到云空间》一节。打包好jar文件后，请登录到执行系统后台，去到插件管理模块编译 jar文件，例如:[http://10.1.28.163:8080/system/settings/index.html\#/portal/:-system-console-vpluginManager](http://10.1.28.163:8080/system/settings/index.html#/portal/:-system-console-vpluginManager)
