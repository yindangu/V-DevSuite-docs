...
这里给出一个最简单的[前端资源包样例](https://qiniu.yindangu.com/vds/demo/demo.zip)，一个html页面通过引用vds来调用V服务的【移动设备硬件操作】规则，来打开App的闪光灯。**注意：下载该资源包后，需要将页面内vds的引用地址修改为您自己的V服务地址（vds的详细使用方法可参考**V-DevSuite JS SDK**）。**
